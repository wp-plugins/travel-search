...
<div style='position:absolute;left:384px;top:102px;'>
	<label title='Use this option if you would like to create the searchbox using JavaScript to hide it from search engines' for="travelSearchUseJavaScript"><strong>Load using JavaScript: </strong></label>

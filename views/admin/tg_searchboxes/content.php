...
<link href="<?php echo plugins_url('/css/tg_searchboxes_color.css', TG_SEARCHBOXES__FILE__); ?>" rel="stylesheet" type="text/css" />
...
ul.asMargin{margin-top:2px;margin-left:10px;position:fixed}

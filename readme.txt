...
1. To track the commission generated by your site, [register to Travelgrove as an Affiliate](https://www.travelgrove.com/affiliates/signup.php?source=wpPlugin) (optional)
2. Log in to [Travelgrove Affiliates](https://www.travelgrove.com/affiliates/login.php?source=wpPlugin) and get your Affiliate ID
...
= IV. Revenue earned =
One can follow the earned commissions inside [Travelgrove's Affiliate interface](https://www.travelgrove.com/affiliates/login.php?source=wpPlugin) -> [Statistics](https://www.travelgrove.com/affiliates/). Also check on screenshot-5.png how a revenue report looks.
...
For full functionality update to version 1.2.4
...
f=[];b(".sb"+a+" .tg_searchbox .tg_container form").find("input, select, textarea").each(function(){f.push({name:this.name,value:this.value,obj:this})});var g=b("#travelSearchUseJavaScript").attr("checked"),d="",e=tgsbFromAir(f),d=d+(e.length?e+",":""),e=tgsbToAir(f),d=d+(e.length?e+",":""),e=tgsbHotelCity(f),d=d+(e.length?e+",":""),e=tgsbDepartureDate(f),d=d+(e.length?e+",":""),e=tgsbReturnDate(f),d=d+(e.length?e+",":""),e=tgsbAdults(f),d=d+(e.length?e+",":""),e=tgsbKids(f),d=d+(e.length?e+",":""),
e=tgsbSeniors(f),d=d+(e.length?e+",":""),e=tgsbRooms(f),d=d+(e.length?e+",":""),e=tgsbRTOW(f),d=d+(e.length?e+",":""),d=d+tgsbCruises(f),d=d+(g?'"usejavascript":"on",':"")+("300x250"==a?"":'"size":"'+a+'",'),d=d+(null==c?'"selectedTab":"flights"':"flights"==c[1]?"":'"selectedTab":"'+c[1]+'"');alignment=setAlignment();d+="alignnone"==alignment?"":'"alignment":"'+alignment+'"';d.match(/\,$/)&&(d=d.replace(/\,$/,""));send_to_editor("[tg_searchboxes"+(d.length?" options='{"+d+"}']":"]"))}return!1});return!1}
var g=b("#ed_toolbar");if(g){var a=document.createElement("input");a.type="button";a.value=TG_Searchboxes_Editor_Button.str_EditorButtonCaption;a.className="ed_button";a.title=TG_Searchboxes_Editor_Button.str_EditorButtonCaption;a.id="ed_button_tg_searchboxes";g.append(a);b("#ed_button_tg_searchboxes").click(c)}});
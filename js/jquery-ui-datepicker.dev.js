/*
 * Customized jQuery UI Datepicker 1.8.17
 *
 ...
 * Depends:
 *	jquery.ui.core.js
 IMPORTANT MODIFICATIONS IN FILE:
 	- jQuery object is copied in tgsb_myjquery variable;
 	- datepicker container's ID was cahanged from `ui-datepicker-div` to `tgsb-ui-datepicker-div`
 		=> needed to make sure no conflicts will show up w/ older datepicker versions
 	- minimum z-index for datepicker div was changed to 12, since our tabs in the plugin have a z-index of 11 and the datepicker div would show up under them w/ lower z-index
 */
(function($, undefined) {
    function isArray(a) {
        ...
        _showDatepicker: function(a) {
            ...
            if (!$.datepicker._isDisabledDatepicker(a) && $.datepicker._lastInput != a) {
                ...
                if (!b.inline) {
                    ...
                    b.dpDiv.zIndex(Math.max($(a).zIndex() + 1, 12)), $.datepicker._datepickerShowing = !0, $.effects && $.effects[g] ? b.dpDiv.show(g, $.datepicker._get(b, "showOptions"), h, i) : b.dpDiv[g || "show"](g ? h : null, i), (!g || !h) && i(), b.input.is(":visible") && !b.input.is(":disabled") && b.input.focus(), $.datepicker._curInst = b
                }
            }
        },

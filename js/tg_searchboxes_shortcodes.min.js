...
d="",e=tgsbFromAir(f),d=d+(e.length?e+",":""),e=tgsbToAir(f),d=d+(e.length?e+",":""),e=tgsbHotelCity(f),d=d+(e.length?e+",":""),e=tgsbDepartureDate(f),d=d+(e.length?e+",":""),e=tgsbReturnDate(f),d=d+(e.length?e+",":""),e=tgsbAdults(f),d=d+(e.length?e+",":""),e=tgsbKids(f),d=d+(e.length?e+",":""),e=tgsbSeniors(f),d=d+(e.length?e+",":""),e=tgsbRooms(f),d=d+(e.length?e+",":""),e=tgsbRTOW(f),d=d+(e.length?e+",":""),d=d+tgsbCruises(f),d=d+(b?'"usejavascript":"on",':"")+("300x250"==a?"":'"size":"'+a+'",'),
d=d+(null==c?'"selectedTab":"flights"':"flights"==c[1]?"":'"selectedTab":"'+c[1]+'"');d.match(/\,$/)&&(d=d.replace(/\,$/,""));a="[tg_searchboxes"+(d.length?" options='{"+d+"}']":"]");"undefined"!=typeof a&&a.length&&(jQuery("#tgsb_shortcodeGenerator #tgsb_shortcode").val(a),jQuery("#tgsb_shortcodeGenerator #tgsb_shortcode_php").val("<?php echo do_shortcode('"+a.replace(/\'/g,"\\'")+"'); ?>"));return!0}

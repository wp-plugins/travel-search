...
c.parents(".tg_searchbox").find(".tg_container > div:not(.cars)").find(".asFrom").val(c.val());c.hasClass("asTo")&&(jQuery(".asTo").val(c.val()),c.parents(".tg_searchbox").find(".tg_container > div.cars").find(".asFrom").val(c.val()))}};function inputFocus(a){this.value==this.defaultValue?this.value="":this.select()}function inputBlur(a){""==this.value&&(this.value=this.defaultValue)}
